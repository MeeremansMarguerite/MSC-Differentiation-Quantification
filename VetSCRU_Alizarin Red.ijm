//MSCs DIFFERENTIATION QUANTIFICATION, based on a differentiation ratio - Alizarin Red S (Osteogenic)
...
//Pink/Grey colors = background (image in channel 2, C2), unstained
...
close("B#"+ nom);
	...
	// Red colors = signal, Calcium production (image in channel 1, C1), based on alizarin red staining
...
//ANALYSIS:
//Divide the % Ca (or area) by the % Background (or area) (representative for the number of cells, cell culture area)
